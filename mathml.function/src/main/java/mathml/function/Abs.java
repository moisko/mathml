...
public class Abs extends AbstractFunctionType {
	private static final long serialVersionUID = 1L;

	public Abs(List<Double> arguments) {
		this(arguments, new ArrayList<Integer>());
	}

	public Abs(List<Double> arguments, List<Integer> nestedApplyElementsNumberList) {
	...
	public Double getResult() throws IllegalArgumentException, ArithmeticException {
		if (arguments.isEmpty()) {
			throw new IllegalArgumentException("No argument specified for function Function.ABS");
		} else {
